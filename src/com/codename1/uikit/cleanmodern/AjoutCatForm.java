...
public class AjoutCatForm extends BaseForm {
    ...
    public AjoutCatForm(Resources res) {
        ...
        setTitle("Ajout Categorie de produit");
        ...
        partage.addActionListener((e) -> {
            ...
            AjoutCatForm a = new AjoutCatForm(res);
            a.show();
            refreshTheme();
        });
        ...
        //
//fin extra
        TextField nom = new TextField("", "entrer nameCategorie!!");
        nom.setUIID("TextFieldBlack");
        addStringValue("nameCategorie", nom);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if (nom.getText().equals("")) {
                    ...
                    category cat = new category(String.valueOf(nom.getText()
                    ).toString()
                    );
                    ...
                    ServiceCategory.getInstance().ajoutercat(cat);
