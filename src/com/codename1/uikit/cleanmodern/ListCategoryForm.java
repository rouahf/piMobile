...
// APPEL AFFICHAGE
     ...
     ArrayList<category>list = ServiceCategory.getInstance().affichagecat();
//        
   for(category cat : list ) {
    ...
    private void updateArrowPosition(Button btn, Label l) {
       ...
       private void addButton(Image img,category cat, Resources res) {
...
//        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(ta));
        // BOUTON AJOUT
        Label nomTxt = new Label("nameCategorie : "+cat.getNom(),"NewsTopLine2");
...
//        //click delete
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceCategory.getInstance().deletecat(cat.getId())) {
