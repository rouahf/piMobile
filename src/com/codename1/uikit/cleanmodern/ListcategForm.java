 ...
 * @author mizoj
 */
public class ListcategForm extends BaseForm {
    
    Form current;
    public ListcategForm(Resources res ) {
...
// APPEL AFFICHAGE
     ...
     ArrayList<Categorie>list = CategorieService.getInstance().getAll();
//        
   for(Categorie ev : list ) {
    ...
    private void updateArrowPosition(Button btn, Label l) {
       ...
       private void addButton(Image img,Categorie ev, Resources res) {
...
if(responseCode >= 200 && responseCode < 300) {
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierCategForm(res,ev).show();
        });
