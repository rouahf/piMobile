 ...
 * @author mizoj
 */
public class AjoutcategForm extends BaseForm {
    

Form current;

public AjoutcategForm (Resources res){
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(type.getText().equals("")) {
                    ...
                    Categorie ev = new Categorie(String.valueOf(type.getText()
                    ).toString()
                            );
                    ...
                    CategorieService.getInstance().add(ev);
