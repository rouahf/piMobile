...
import com.codename1.uikit.cleanmodern.ListReclamationForm;
import com.codename1.uikit.cleanmodern.ModifierReclamationForm;
...
public class ReclamationFRont extends BaseForm2 {
    Form current;
    public ReclamationFRont(Resources res ) {
...
//        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(ta));
        // BOUTON AJOUT
        Label id_userTxt = new Label("id_user : "+rec.getId_user(),"NewsTopLine2");
        Label emailTxt = new Label("type : "+rec.getEmail(),"NewsTopLine2");
        Label categorieTxt = new Label("categorie : "+rec.getCategorie(),"NewsTopLine2");
        Label etat_reclamationTxt = new Label("etat_reclamation : "+rec.getEtat_reclamation(),"NewsTopLine2");
        Label prioriteTxt = new Label(" priorite : "+rec.getPriorite(),"NewsTopLine2");
...
//        //click delete
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                BoxLayout.encloseX(id_userTxt),
                BoxLayout.encloseX(emailTxt),
                BoxLayout.encloseX(categorieTxt),
                BoxLayout.encloseX(etat_reclamationTxt),
                BoxLayout.encloseX(prioriteTxt),
