...
import com.codename1.uikit.cleanmodern.EditCoursForm;
import com.codename1.uikit.cleanmodern.ListCoursForm;
import com.codename1.uikit.cleanmodern.StatsCours;
import com.codename1.uikit.cleanmodern.ajouterCoursForm;
...
public class ListeCoursFront extends BaseForm2 {
    ...
    super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
      ...
      tb.addSearchCommand(e ->  {
        ...
        RadioButton partage = RadioButton.createToggle("Coursf", barGroup);
...
////                if (success) {
////                    Dialog.show("Suppression", "Cours supprimé avec succès", "OK", null);
////                    new ListCoursForm(res).show();
////                } else {
////                    Dialog.show("Erreur", "Erreur lors de la suppression du Cours", "OK", null);
////                }
//            });
...
//                System.out.println("hello update");
//               new com.codename1.uikit.cleanmodern.recSearch(res).show();
//
//            });
