...
//Map<String, Integer> eventStats = serviceEvent.getEventStatsByType();
//
//        
//        
//    int[] colors = new int[eventStats.size()];
//    Arrays.fill(colors, 0xf4b342); // Use the same color for all the pie chart sections
//
//    DefaultRenderer renderer = buildCatRendrer(colors);
//    renderer.setLabelsColor(0x000000); // black color for labels.
//
...
//
//    // Create the chart
//    PieChart chart = new PieChart(buildDataset("Event Types", eventStats), renderer);
//
//    // Add the chart to a component
//    ChartComponent c  = new ChartComponent(chart);
//
//    String[] messages = {"Event statistics by type"};
//    SpanLabel message = new SpanLabel(messages[0], "WelcomeMessage");
//
//    Container cnt = BorderLayout.center(message);
//    cnt.setUIID("Container");
...
private CategorySeries buildDataset(String title, Map<String, Integer> eventStats) {
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Event",prcntRec);
        series.add("Type",prcntFeed);
