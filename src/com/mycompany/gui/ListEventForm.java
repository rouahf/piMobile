...
public class ListEventForm extends BaseForm {
    ...
    super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes Events", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
         ...
         StatistiquePieForm b = new StatistiquePieForm(res);
           b.show();
            refreshTheme();
        });
        //
        RadioButton radioButton = new RadioButton("Open ListEventForm");

partage.addActionListener(new ActionListener() {
    @Override
    public void actionPerformed(ActionEvent evt) {
       AjoutEventForm ajout = new AjoutEventForm(res);
       ajout.show();
       refreshTheme();
    }
});
...
//        
   for(Event ev : list ) {
    ...
    private void updateArrowPosition(Button btn, Label l) {
       ...
       private void addButton(Image img,Event ev, Resources res) {
...
//        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(ta));
        ...
        Label typeTxt = new Label("type : "+ev.getType(),"NewsTopLine2");
...
//        //click delete
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceEvent.getInstance().deleteEvent(ev.getId())) {
